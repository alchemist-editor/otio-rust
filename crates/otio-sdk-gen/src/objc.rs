...
ifeq ($(UNAME),Darwin)
    ...
    #
    # Debian and Ubuntu ship the Objective-C runtime's own headers
    # (`objc/objc.h`) with GCC rather than on the system include path, and
    # clang does not look there by itself.
